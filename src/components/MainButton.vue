<template>
  ...
  >
    ...
    <span class="main-button__text" :data-animate="disableAnimation ? undefined : 'title'">{{ text }}</span>
    <span class="main-button__icon" :data-animate="disableAnimation ? undefined : 'fill'" :data-animate-fill-direction="disableAnimation ? undefined : 'right'">
      <IconArrowRight />
    </span>
  </a>
</template>
