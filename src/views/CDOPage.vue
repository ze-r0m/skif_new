          ...
          <div class="grid">
            <div class="col-8">
              <div class="app-section__head">
                <h1 class="text-h1" data-animate="title">Отдел сопровождения дистанционного образования</h1>
              </div>
              <div class="text-content">
                <p class="text-body" style="margin-top: 0;" data-animate="text">Отдел СДО выполняет ряд ключевых функций, направленных на поддержку и развитие электронного обучения в ДГТУ. Он обеспечивает консультационную поддержку по использованию дистанционных технологий и внедрению электронного обучения, а также оказывает техническую и методическую помощь преподавателям в создании курсов электронного обучения, включая открытые онлайн-курсы.</p>
                <p class="text-body" data-animate="text">Основные направления работы отдела:</p>
                <FeatureList :items="features"/>
                <p class="text-body" data-animate="text">Отдел проводит техническую экспертизу контента и помогает кафедрам и авторам в разработке электронных учебно-методических изданий на портале электронного обучения ДГТУ.</p>
              </div>
            </div>
            <aside class="col-4">
