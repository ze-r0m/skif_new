          ...
          <div class="grid">
            <div class="col-8">
              <div class="app-section__head">
                <h1 class="text-h1" data-animate="title">Отдел сопровождения образовательной логистики</h1>
              </div>
              <div class="text-content">
                <p class="text-body" style="margin-top: 0;" data-animate="text">ООЛ занимается сбором исходной информации, необходимой для создания проекта расписания учебных занятий. Отвечает за разработку и составление расписания для различных учебных групп, включая распределение учебных занятий и промежуточных аттестаций.</p>
                <p class="text-body" data-animate="text">Основные направления работы отдела:</p>
                <FeatureList :items="features"/>
                <p class="text-body" data-animate="text"> При внедрении образовательных траекторий отдел формирует расписание для обучающихся и направлений профессионального роста, обеспечивая логическую последовательность и взаимосвязи между различными модулями в расписании.</p>
              </div>
            </div>
